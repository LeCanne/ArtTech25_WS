...
class RigLayers(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.prop(context.active_object.data, 'layers', index=20, toggle=True, text='Hair')
        row.prop(context.active_object.data, 'layers', index=21, toggle=True, text='Hair Tweak')
        ...
        row.prop(context.active_object.data, 'layers', index=11, toggle=True, text='FK')

        row = col.row()
        row.prop(context.active_object.data, 'layers', index=9, toggle=True, text='Tweak')
        row.prop(context.active_object.data, 'layers', index=12, toggle=True, text='Tweak')
        ...
        row = col.row()
        row.prop(context.active_object.data, 'layers', index=14, toggle=True, text='FK')
        row.prop(context.active_object.data, 'layers', index=17, toggle=True, text='FK')

        row = col.row()
        row.prop(context.active_object.data, 'layers', index=15, toggle=True, text='Tweak')
        row.prop(context.active_object.data, 'layers', index=18, toggle=True, text='Tweak')
        
        row = col.row()
        row = col.row()
        row = col.row()
        row.prop(context.active_object.data, 'layers', index=23, toggle=True, text='Gun')

        row = col.row()
        row.separator()
        row = col.row()
        row.prop(context.active_object.data, 'layers', index=22, toggle=True, text='Cloth')
        row = col.row()
        row.separator()
